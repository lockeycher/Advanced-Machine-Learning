...
if binning==1 and cross_val==1:
    ...
    start_ts=time.time()
    clf=GradientBoostingClassifier(loss='deviance', learning_rate=0.1, n_estimators=100, min_samples_split=3, max_depth=3, random_state=rand_st)
    #clf=GradientBoostingClassifier(loss='deviance', learning_rate=0.1, n_estimators=100, min_samples_split=3, max_depth=5, random_state=rand_st)
    #clf=GradientBoostingClassifier(loss='deviance', learning_rate=0.1, n_estimators=100, min_samples_split=3, max_depth=7, random_state=rand_st)
    ...
    start_ts=time.time()
    #clf=MLPClassifier(hidden_layer_sizes=(10, ), activation='logistic', solver='lbfgs', alpha=0.0001, max_iter=1000, random_state=rand_st)

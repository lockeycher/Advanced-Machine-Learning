...
if cross_val==1:
    ...
    start_ts=time.time()
    clf = RandomForestClassifier(n_estimators=100, max_depth=None, min_samples_split=3, criterion='entropy', random_state=rand_st)
    #clf = RandomForestClassifier(n_estimators=5, max_depth=None, min_samples_split=3, criterion='entropy', random_state=rand_st)
    #clf = RandomForestClassifier(n_estimators=10, max_depth=None, min_samples_split=3, criterion='entropy', random_state=rand_st)
    #clf = RandomForestClassifier(n_estimators=20, max_depth=None, min_samples_split=3, criterion='entropy', random_state=rand_st)
    ...
    #clf = RandomForestClassifier(n_estimators=1000, max_depth=None, min_samples_split=3, criterion='entropy', random_state=rand_st)

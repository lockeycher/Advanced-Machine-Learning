...
if binning==0 and cross_val==1:
    ...
    start_ts=time.time()
    rgr = RandomForestRegressor(n_estimators=100, max_features=.33, max_depth=None, min_samples_split=3, criterion='mse', random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=5, max_features=.33, max_depth=None, min_samples_split=3, criterion='mse', random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=10, max_features=.33, max_depth=None, min_samples_split=3, criterion='mse', random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=20, max_features=.33, max_depth=None, min_samples_split=3, criterion='mse', random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=50, max_features=.33, max_depth=None, min_samples_split=3, criterion='mse', random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=200, max_features=.33, max_depth=None, min_samples_split=3, criterion='mse', random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=500, max_features=.33, max_depth=None, min_samples_split=3, criterion='mse', random_state=rand_st)
    #rgr = RandomForestRegressor(n_estimators=1000, max_features=.33, max_depth=None, min_samples_split=3, criterion='mse', random_state=rand_st)
